        ...
        {services.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {services.slice(0, 8).map((service) => (
              <div key={service.id} className="group bg-white rounded-xl border border-slate-200 hover:border-amber-300 hover:shadow-md p-5 transition-all duration-200 cursor-default">
                ...
                <h3 className="text-slate-900 text-sm font-semibold mb-1.5 line-clamp-2">
                  {service.nombre}
                </h3>
                {service.descripcion && (
