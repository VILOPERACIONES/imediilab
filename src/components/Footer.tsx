        ...
        <div className="grid grid-cols-4 gap-12 max-md:grid-cols-2 max-sm:grid-cols-1">
          ...
          <div>
            <div className="mb-4 px-2">
              <img src={logo} className="h-12 object-contain" alt="IMEDILAB Logo" />
            </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3 text-sm text-slate-500">
              ...
              <a href="/servicios?q=Rayos" className="hover:text-slate-900 transition-colors">
                Rayos X
              </a>
              <a href="/servicios?q=Ultrasonido" className="hover:text-slate-900 transition-colors">
                Ultrasonidos
              </a>
              <a href="/servicios" className="hover:text-slate-900 transition-colors">
                Salud Ocupacional
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3 text-sm text-slate-500">
              <span>
                Aviso de Funcionamiento: <span className="text-slate-700">#234567</span>
              </span>
              <span>
                Resp. Sanitario: <span className="text-slate-700">Q.F.B. 12345</span>
              </span>
        ...
        <div className="max-w-[1200px] mx-auto px-20 py-6 max-md:px-5">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-5">
              <a
                href="https://www.facebook.com/share/1B9im3Xv28/?mibextid=wwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/imedilabmid?igsh=cGJ3b3dwNHFsOWFx"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-slate-600 transition-colors"
              >
